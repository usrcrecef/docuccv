...
3. Da clic en el botón <img src={require('./utils/boton-connect-ovpn.png').default} style={{width: '120px'}}/>. Al conectarse nos debe de mostrar una ventana como la siguiente:
